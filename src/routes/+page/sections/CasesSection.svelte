...
{#snippet caseItem()}
  <article class="case">
    <img src={caseThumb.img.src} alt="" loading="lazy">
    <div class="content">
      <h3>Разработка инновационного продукта по измерению уровня зумерства</h3>
    </div>
  </article>
{/snippet}
  ...
  <div class="content">
    <div class="case focused-case">
      ...
      <div class="content">
        ...
        <p>
          Роскосмос обратился с проблемой ежедневного залипания зумеров в телефоны, убивая процент продаж и полезного действия. Для улучшения качества работы мы создали ультра модный провод
        </p>
